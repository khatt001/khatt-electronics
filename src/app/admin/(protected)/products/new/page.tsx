...
export default async function NewProductPage({
  ...
  return (
    <div>
      ...
      <form action={createProduct} className="grid gap-8 xl:grid-cols-[1fr_340px]">
        ...
        <aside className="space-y-5">
          ...
          <div>
            ...
            />
              ...
              <div>
  <label className="mb-2 block text-sm font-medium">Əsas şəkil</label>
  <input
    name="image"
    type="file"
  ...
  />
  <p className="mt-2 text-xs text-neutral-500">
    JPG, PNG və ya WEBP. Maksimum 3MB.
  </p>
</div>
