...
export const metadata: Metadata = {
  title: "Müqayisə",
  description:
    "KHATT Electronics məhsul müqayisə səhifəsi. Məhsulları texniki göstəricilərə görə müqayisə edin.",
  alternates: {
    canonical: "/compare",
  },
};
        ...
        <Container>
          <div className="mx-auto max-w-3xl rounded-[2rem] border border-neutral-200 bg-white p-8 text-center shadow-sm lg:p-12">
            ...
            <h1 className="mt-4 text-4xl font-semibold leading-tight text-neutral-950 md:text-5xl">
              Məhsul müqayisəsi hazırlanır
            </h1>

            <p className="mx-auto mt-5 max-w-xl leading-8 text-neutral-600">
              Tezliklə kamera, şəbəkə və təhlükəsizlik məhsullarını texniki
              göstəricilərinə görə yan-yana müqayisə edə biləcəksiniz.
            </p>
